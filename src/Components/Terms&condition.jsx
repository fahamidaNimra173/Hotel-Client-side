...
const TermsAndCondition = () => {
  ...
  return (
    <section className="py-16 px-4 pt-30 md:px-8 lg:px-16">
        ...
        >
          <div className="relative inline-block mb-6">
            ...
            <motion.div
              ...
              className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 h-2 bg-[#ffbd59]"
            ></motion.div>
          </div>
          <motion.p
            initial={{ opacity: 0 }}
            ...
            className="mt-8 text-lg text-[#28140c] max-w-3xl mx-auto leading-relaxed"
          >
            At <span className="text-[#ffbd59] eb font-bold">AurIs Hotel</span>, we are committed to making your stay exceptional. These terms ensure a safe, fair, and enjoyable experience for all our guests.
          </motion.p>
        </motion.div>
      </div>
        ...
        >
          <div className="bg-[#28140c] rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden border-l-8 border-[#ffbd59]">
            ...
            <div className="relative z-10 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#ffbd59] castoro mb-3">1. Reservations & Payment</h3>
        ...
        >
          <div className="bg-gradient-to-br from-[#ffbd59] to-[#ffd891] rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden border-r-8 border-[#28140c]">
            ...
            <div className="relative z-10 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#28140c] castoro mb-3">2. Check-In & Check-Out</h3>
        ...
        >
          <div className="bg-[#28140c] rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden border-l-8 border-[#ffbd59]">
            ...
            <div className="relative z-10 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#ffbd59] castoro mb-3">3. Cancellation Policy</h3>
                <p className="text-white eb text-lg leading-relaxed">
        ...
        >
          <div className="bg-gradient-to-br from-[#ffbd59] to-[#ffd891] rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden border-r-8 border-[#28140c]">
            ...
            <div className="relative z-10 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold castoro text-[#28140c] mb-3">4. Guest Responsibilities</h3>
                <p className="text-[#28140c] eb text-lg leading-relaxed">
        ...
        >
          <div className="bg-[#28140c] rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden border-l-8 border-[#ffbd59]">
            ...
            <div className="relative z-10 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold castoro text-[#ffbd59] mb-3">5. Smoking & Pets</h3>
                <p className="text-white eb text-lg leading-relaxed">
        ...
        >
          <div className="bg-gradient-to-br from-[#ffbd59] to-[#ffd891] rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden border-r-8 border-[#28140c]">
            ...
            <div className="relative z-10 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold castoro text-[#28140c] mb-3">6. Privacy & Data Protection</h3>
                <p className="text-[#28140c] eb text-lg leading-relaxed">
        ...
        >
          <div className="bg-[#28140c] rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden border-l-8 border-[#ffbd59]">
            ...
            <div className="relative z-10 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#ffbd59] castoro mb-3">7. Changes to Terms</h3>
                <p className="text-white v leading-relaxed">
      ...
      >
        <div className="relative bg-[#28140c] rounded-3xl overflow-hidden shadow-2xl">
